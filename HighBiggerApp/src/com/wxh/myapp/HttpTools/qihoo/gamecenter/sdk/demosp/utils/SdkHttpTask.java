...
public class SdkHttpTask extends AsyncTask<String, Void, String> {
	...
	private JSONObject mKeyValueOblect;
	...
	public void doPost(SdkHttpListener listener, JSONObject keyValueObject, String url) {
		this.mListener = listener;
		this.mIsHttpPost = true;
		this.mKeyValueOblect = keyValueObject;
		this.mRetryCount = 0;
	...
	private HttpResponse executeHttp(Context context, String uri) throws SSLHandshakeException,
		...
		return mIsHttpPost ? post(context, uri, mKeyValueOblect) : get(context, uri);
	}
	...
	private static HttpResponse post(Context context, String url, JSONObject params) throws SSLHandshakeException,
			ClientProtocolException, IOException {
	...
	private static HttpResponse get(Context context, String url) throws SSLHandshakeException, ClientProtocolException,
			IOException {
		url = url.replaceAll(" ", "%20");
		HttpClient httpClient = new DefaultHttpClient();
		HttpParams httpParams = httpClient.getParams();
